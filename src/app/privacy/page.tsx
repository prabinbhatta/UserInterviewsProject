    ...
    <div className="flex flex-1 flex-col items-center bg-[var(--paper)] px-6 py-16">
      <div className="w-full max-w-2xl">
        ...
        <div className="mt-8 space-y-6 text-[var(--ink)]/80">
          ...
          <section>
            <h2 className="font-semibold text-[var(--ink)]">1. What we collect</h2>
          ...
          <section>
            <h2 className="font-semibold text-[var(--ink)]">2. How we use it</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-semibold text-[var(--ink)]">3. Who can see it</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-semibold text-[var(--ink)]">4. Payments</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-semibold text-[var(--ink)]">5. Data retention</h2>
            <p className="mt-2">
          ...
          <section>
            <h2 className="font-semibold text-[var(--ink)]">6. Security</h2>
            <p className="mt-2">
