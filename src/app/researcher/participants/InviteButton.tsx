  ...
  if (state.invitedToken) {
    ...
    return (
      <button
        ...
        className="shrink-0 rounded-full border border-[var(--mist)] px-3 py-1.5 text-xs font-medium text-[var(--ink)]/70 transition-colors hover:border-[var(--coral)] hover:text-[var(--ink)]"
      >
